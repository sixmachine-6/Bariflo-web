function Title() {
  return (
    <div className="absolute top-[7rem] sm:top-[9rem] md:top-[15rem] lg:top-[17rem] px-3 sm:px-7 md:px-10 space-y-2">
      <h2 className="text-white text-xl font-bold sm:text-2xl md:text-3xl lg:text-4xl ">
